...
-   For $Z \sim Pois(\lambda)$, $E(Z) = \lambda$ and I expect if I observe this observe this interval, over and over again, I would expect an average of around $\lambda$ events
