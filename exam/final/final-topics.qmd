...
- What is a regression line? What are residuals? What is error? What does "least squares" refer to? Know how to write out a linear model for a particular study, indexed by observation $i = 1, \ldots, n$.Be able to define all terms in the model. 
...
- In regression output, what are the individual coefficient statistics and p-values telling us? Which hypothesis test is being conducted for each p-value? What is the distribution of the t-statistic given in the R output? (include degrees of freedom)

  - For the global F-test, what is the distribution of the test statistic (including degrees of freedom)? How would you interpret a p-value from the overall test?

- $R^2$ and Adjusted $R^2$: definitions and how to interpret
