...
Spearman’s correlation is a rank-based measure and is useful when the relationship between two variables might not be linear, or when there may be outliers present in the data. 
