...
So for a female (when gender = 0; which means reference group for gender), we expect the change in SBP of 0.4426 mmHg corresponding to a 1 kg/m2 increase in BMI

We could also state that a 1 kg/m2 increase in BMI is associated with a 0.426 + (-1.44)*(Gender = male) mmHg increase in systolic blood pressure, so leave the increase in mmHg corresponding to a change in 1 kg/m2 in BMI as a function of Gender
