...
- Homework #1 posted to Canvas today. Due next Thurdsay Jan 22 at 11:59pm.
- **Reminder** Office hours today for Dr. Howard from 9:45-10:45 in McGavern-Greenberg 3101A
- Reach out to me or the TAs if you need assistance outside of office hours 
...
## Download or print notes to PDF {.small}
...
- pharmaceutical sciences, clinical research, genetics, epidemiology, nutrition & metabolic diseases, immunology, public health policy, neuro Oncology, occupational health, industrial toxicology (+ intersection with environmental justice), disaster resilience networks + mutual aid, real-world applications, community health research, medicaid policy, dental research, biomedical engineering, cancer therapy, air + water quality, food systems, Adverse Childhood Experiences, reproductive disorders, biomechanics, & more!

## Hopes

- Getting more comfortable coding in R, how can biostatistics inform understanding of health data, learning correct statistical test to use for data, understand meaning behind research results & how we get to those results, review statistics which I haven't seen since AP Stats, making R workflow more structured + reproducible, how to analyze + interpret data accurately, & more

## R + supportive learning

- R experience: Mostly never used R before! Many beginners, a few with more experience

- What supports learning: step-by-step examples + independent practice, hands-on coding, visuals, group work + discussion, steady pace + clear instructions
