...
- Let's go back to our example to test if higher SBP is associated with lower cognitive scores where we think age might be a confounder

- If I just include SBP as a predictor, what does the model suggest?
...
- Now, if I include both SBP and age as predictors, what does the model suggest?
