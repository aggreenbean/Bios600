...
```{r echo = T}
cdc <- read.csv("https://aggreenbean.github.io/Course-Slides/Bios%20600/labs/data/cdc_cleaned.csv")
```
...
```{r}
download.file("https://karamccor.github.io/b6002/labs/lab-01-template.qmd",
              destfile="lab-01.qmd")
```
