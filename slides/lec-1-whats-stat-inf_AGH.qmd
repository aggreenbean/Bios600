...
- TA office hours will be Tuesdays 2:20-3:20pm in MCG 2303. Stop by whenever you need help!

- Moving forward on assignments, be sure to assign each question to the corresponding page in your PDF document. 

- Reach out to the TAs if you need help installing R/RStudio!
...
-   \textcolor{brown}{Reproducibility}: being able to take original data and code to reproduce all numerical findings.

-   \textcolor{brown}{Replicability}: being able to independently repeat an entire study without use of the original data (generally with the same methods)
